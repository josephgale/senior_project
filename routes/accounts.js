...
//controllers
const {signup,activate,pwResetRequest,pwReset,googleLogin,login,newLesson,getLessons,updateLesson,deleteLesson,getEnrollmentOptions,enroll,getEnrolledLessons,getLessonById,updateLessonProgress} = require('../controllers/auth')
